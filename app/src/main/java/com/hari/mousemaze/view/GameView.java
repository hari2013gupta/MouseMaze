...
import com.hari.mousemaze.Game;
...
//		game = new Game();
		b4 = new Button(this.context);
	       System.out.println("----------b4 button-------//"+b4);
	       b4.setText("B4");
	       b4.setLayoutParams(rlpBottom);
//		System.out.println("-----------b4-----------//"+this.game.b4);
//		
...
//				 moved = maze.move(Maze.DOWN);
	    		 System.out.println("--------vv.up()-----button4"+moved);
			}
		});
	}
...
////				moved=up();
//				System.out.println("------------KEYCODE_DPAD_UP"+KeyEvent.KEYCODE_DPAD_UP);
//				break;
//			case KeyEvent.KEYCODE_DPAD_DOWN:
////				moved = maze.move(Maze.DOWN);
////				moved=down();
//				System.out.println("------------KEYCODE_DPAD_DOWN"+KeyEvent.KEYCODE_DPAD_DOWN);
//				break;
//			case KeyEvent.KEYCODE_DPAD_RIGHT:
////				moved = maze.move(Maze.RIGHT);
//				System.out.println("------------KEYCODE_DPAD_RIGHT"+KeyEvent.KEYCODE_DPAD_RIGHT);
//				break;
//			case KeyEvent.KEYCODE_DPAD_LEFT:
////				moved = maze.move(Maze.LEFT);
//				System.out.println("------------KEYCODE_DPAD_LEFT"+KeyEvent.KEYCODE_DPAD_LEFT);
//				break;
//			default:
...
//		// TODO Auto-generated method stub
//		if(v==game.b2){
//			game.b2.setOnClickListener(new OnClickListener() {
//				
//				@Override
//				public void onClick(View v) {
//					// TODO Auto-generated method stub
